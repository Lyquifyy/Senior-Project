...
def predict_single_image(img, pipeline, label_encoder, bounding_box=None):
...
def main():
    ...
    try:
        ...
        # Test image
        single_image_path = "C:/Users/clair/Downloads/BITVehicle/vehicle_0000453.jpg"
        #single_image_path = "C:/Users/clair/OneDrive/Pictures/Screenshots/test.png"

        img = cv2.imread("some_image.jpg")
        vehicle_type = predict_single_image(img, pipeline, label_encoder)

        #vehicle_type = predict_single_image(frame_from_video, pipeline, label_encoder)
